...
const Footer = ({ id }: { id: string }) => {
  return (
    <footer
      id={id}
      className="mx-auto mb-2.5 mt-10 flex h-[37px] flex-row items-center justify-between rounded-[10px] py-[5px] text-black opacity-0 md:mb-4 md:mt-16 lg:mb-10 lg:mt-24  2xl:max-w-[1400px]"
    >
